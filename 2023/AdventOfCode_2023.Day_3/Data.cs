namespace AdventOfCode_2023.Day_3
{
	...
	{
		public static Regex FirstNumber = firstNumberRegex();

		public static Regex NumberPrevAsterix = numberPrevAsterixRegex();

		public static Regex NumberPostAsterix = numberPostAsterixRegex();

		public static Regex NumbersOfLine = numbersOfLineRegex();
		...
		[GeneratedRegex("(\\d+)\\*$")]
		private static partial Regex numberPrevAsterixRegex();

		[GeneratedRegex("^\\*(\\d+)")]
		private static partial Regex numberPostAsterixRegex();

		[GeneratedRegex(@"\d+")]
		private static partial Regex numbersOfLineRegex();
	}
}
